...
describe 'Admin aprova um outro admin' do
  it 'com sucesso' do
    ...
    to_approve_admin = create(:admin, :not_approved, full_name:"Fernando", email: "fernando@userubis.com.br", cpf:"12555778904", password:"123456")

    login_as(admin)
    post(create_approval_path(to_approve_admin), params: { approval: {admin: to_approve_admin, super_admin_email: admin.email }} )
